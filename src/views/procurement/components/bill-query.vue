...
import { procurementApi } from "@/api/procurement/index.js";
import billAdd from "./bill-add.vue";
  ...
  methods: {
    ...
    btnDelete() {
      ...
      this.$confirm("是否删除该条数据?", "提示", {
        ...
        .then(() => {
          this.api.Delete({ FInterID }).then(res => {
            if (res.data) {
              this.$message({
                type: "success",
                message: "删除成功!"
