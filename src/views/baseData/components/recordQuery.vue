<template>
  <gl-bill-structure BillType="档案" style="color:red">
    <template v-slot:btn>
      <gl-button :btnTexts="btnTexts" @btnAdd="add" @btnEdit="edit" @btnDelete="btnDelete"></gl-button>
    </template>
    <template v-slot:form>
      <form-render :content="pageSetting.formOptions" ref="glform" :inline="true">
        <el-form-item>
          <el-button type="primary" size="mini" :loading="btnLoading" @click="query">查询</el-button>
        </el-form-item>
      </form-render>
    </template>
    ...
    <template v-slot:table>
      ...
      <el-pagination
        ...
        :total="total"
      ></el-pagination>
      <el-dialog :title="billName" :visible.sync="dialogVisible" fullscreen destroy-on-close>
        <record-add :pageSetting="pageSetting"></record-add>
      </el-dialog>
    </template>
  </gl-bill-structure>
</template>
